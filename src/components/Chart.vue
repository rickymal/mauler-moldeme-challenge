...
<script setup lang="ts">
  ...
  import { Chart, LineController, CategoryScale, LinearScale, PointElement, LineElement, Title, Legend } from 'chart.js';
  ...
  let chart = null;  // Referência do gráfico a ser atualizada
